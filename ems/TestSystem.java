...
public class TestSystem {
  public static void main (String[] args) { 
    ...
    attendanceRecordSystem.addDayRecord(uuid, new CustomDate(2023, 5, 15), new AttendanceDayRecord(uuid, 1, 0, new LeaveRecord("病假" ,new Message(), new Time(9,0), new Time(13,0)), false, false));
    ...
    attendanceRecordSystem.addDayRecord(uuid, new CustomDate(2023, 5, 5), new AttendanceDayRecord(uuid,4, 0, new LeaveRecord("事假" ,new Message(), new Time(13,0), new Time(17,0)), false, false));
